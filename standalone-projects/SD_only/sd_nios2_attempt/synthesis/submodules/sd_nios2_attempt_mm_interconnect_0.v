// sd_nios2_attempt_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module sd_nios2_attempt_mm_interconnect_0 (
	...
	wire   [9:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> timer_s1_agent:cp_channel
	...
	wire  [97:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> key_s1_agent:cp_data
	...
	wire  [19:0] sd_dat_s1_agent_m0_address;                                                // sd_dat_s1_agent:m0_address -> sd_dat_s1_translator:uav_address
	...
	wire  [98:0] sd_dat_s1_agent_rf_source_data;                                            // sd_dat_s1_agent:rf_source_data -> sd_dat_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] sd_dat_s1_agent_rsp_fifo_out_data;                                         // sd_dat_s1_agent_rsp_fifo:out_data -> sd_dat_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> sd_dat_s1_agent:cp_valid
	wire  [97:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> sd_dat_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // sd_dat_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [9:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> sd_dat_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> sd_dat_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> sd_dat_s1_agent:cp_endofpacket
	...
	wire  [19:0] sd_cmd_s1_agent_m0_address;                                                // sd_cmd_s1_agent:m0_address -> sd_cmd_s1_translator:uav_address
	...
	wire  [98:0] sd_cmd_s1_agent_rf_source_data;                                            // sd_cmd_s1_agent:rf_source_data -> sd_cmd_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] sd_cmd_s1_agent_rsp_fifo_out_data;                                         // sd_cmd_s1_agent_rsp_fifo:out_data -> sd_cmd_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> sd_cmd_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                     // sd_cmd_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [9:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> sd_cmd_s1_agent:cp_channel
	...
	wire  [98:0] sd_wp_n_s1_agent_rf_source_data;                                           // sd_wp_n_s1_agent:rf_source_data -> sd_wp_n_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] sd_wp_n_s1_agent_rsp_fifo_out_data;                                        // sd_wp_n_s1_agent_rsp_fifo:out_data -> sd_wp_n_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_008_src_data;                                                      // cmd_mux_008:src_data -> sd_wp_n_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                     // sd_wp_n_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [9:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> sd_wp_n_s1_agent:cp_channel
	...
	wire  [98:0] sd_clk_s1_agent_rf_source_data;                                            // sd_clk_s1_agent:rf_source_data -> sd_clk_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] sd_clk_s1_agent_rsp_fifo_out_data;                                         // sd_clk_s1_agent_rsp_fifo:out_data -> sd_clk_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_009_src_data;                                                      // cmd_mux_009:src_data -> sd_clk_s1_agent:cp_data
	wire         cmd_mux_009_src_ready;                                                     // sd_clk_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [9:0] cmd_mux_009_src_channel;                                                   // cmd_mux_009:src_channel -> sd_clk_s1_agent:cp_channel
	...
	wire  [97:0] key_s1_agent_rp_data;                                                      // key_s1_agent:rp_data -> router_007:sink_data
	...
	wire         sd_dat_s1_agent_rp_valid;                                                  // sd_dat_s1_agent:rp_valid -> router_008:sink_valid
	wire  [97:0] sd_dat_s1_agent_rp_data;                                                   // sd_dat_s1_agent:rp_data -> router_008:sink_data
	wire         sd_dat_s1_agent_rp_ready;                                                  // router_008:sink_ready -> sd_dat_s1_agent:rp_ready
	wire         sd_dat_s1_agent_rp_startofpacket;                                          // sd_dat_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         sd_dat_s1_agent_rp_endofpacket;                                            // sd_dat_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire  [97:0] sd_cmd_s1_agent_rp_data;                                                   // sd_cmd_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [97:0] sd_wp_n_s1_agent_rp_data;                                                  // sd_wp_n_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [97:0] sd_clk_s1_agent_rp_data;                                                   // sd_clk_s1_agent:rp_data -> router_011:sink_data
	...
	wire         sd_dat_s1_agent_rdata_fifo_src_valid;                                      // sd_dat_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] sd_dat_s1_agent_rdata_fifo_src_data;                                       // sd_dat_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         sd_dat_s1_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_006:in_0_ready -> sd_dat_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> sd_dat_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> sd_dat_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                         // sd_dat_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> sd_dat_s1_agent:rdata_fifo_sink_error
	...
	sd_nios2_attempt_mm_interconnect_0_router router (
	...
	sd_nios2_attempt_mm_interconnect_0_router_001 router_001 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_002 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_003 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_004 router_004 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_004 router_005 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_006 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_007 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_008 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_009 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_010 (
	...
	sd_nios2_attempt_mm_interconnect_0_router_002 router_011 (
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	sd_nios2_attempt_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
