...
;	JR   NC,MAIN_WAITING_LOOP ; Ignore by jumping back to wait for another key.
...
;        C=00 if main menu 
TOGGLE_MENU_HIGHLIGHT:	;; WAS 3C06 (L37CA)																	; CHANGED TO WORK WITH BOTH
...
BASIC_HNDLR:
	...
	LD HL, $FFFF		;
	SET 0, (HL)			; setting bit 0 of my menu flag to 1, signifying BASIC is on instead of menu
...
; ------------
; C=00 if main menu
MOVE_UP:    																								; CHANGED PARAMETERS FOR BOTH TO WORK
...
; --------------
; C=00 if main menu
MOVE_DN:    																								; CHANGED PARAMETERS FOR BOTH TO WORK
	PUSH DE           ; Save DE.
...
SINCLAIR_STRIPES:  ; WAS 3C80 CHANGE PLS
